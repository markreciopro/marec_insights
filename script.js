...
/* 0. DUAL-COLOR SPLIT BELL CURVE ENGINE (APPLE RED / PROGRAMMING BLUE) */
(function () {
  'use strict';
  ...
  function drawLiveBellCurve() {
    ...
    // Lower baseline slightly to clear top element overlap
    ...
    // --- 1. LEFT HALF FILL (APPLE RED TAIL) ---
    ctx.beginPath();
    ...
    leftGradient.addColorStop(0.0, "rgba(244, 63, 94, 0.02)");
    leftGradient.addColorStop(0.5, "rgba(244, 63, 94, 0.22)");
    leftGradient.addColorStop(1.0, "rgba(244, 63, 94, 0.48)");
    ctx.fillStyle = leftGradient;
    ctx.fill();

    // --- 2. RIGHT HALF FILL (PROGRAMMING / TERMINAL BLUE TAIL) ---
    ctx.beginPath();
    ...
    rightGradient.addColorStop(0.0, "rgba(59, 130, 246, 0.02)");
    rightGradient.addColorStop(0.5, "rgba(59, 130, 246, 0.25)");
    rightGradient.addColorStop(1.0, "rgba(96, 165, 250, 0.52)");
    ctx.fillStyle = rightGradient;
    ctx.fill();

    // --- 3. LEFT STROKE (APPLE RED) ---
    ctx.beginPath();
    for (let i = 0; i <= peakIndex; i++) {
    ...
    // --- 4. RIGHT STROKE (PROGRAMMING BLUE) ---
    ctx.beginPath();
    for (let i = peakIndex; i < points.length; i++) {
