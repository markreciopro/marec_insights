...
/* 0. DUAL-COLOR SPLIT BELL CURVE ENGINE (SHADED APPLE RED / EMERALD GREEN) */
(function () {
  'use strict';
  ...
  function drawLiveBellCurve() {
    ...
    // --- 1. LEFT HALF FILL (SHADED APPLE RED TAIL) ---
    ctx.beginPath();
    ...
    leftGradient.addColorStop(0.0, "rgba(225, 29, 72, 0.02)");
    leftGradient.addColorStop(0.5, "rgba(225, 29, 72, 0.22)");
    ...
    // --- 3. LEFT STROKE (SHADED APPLE RED) ---
    ctx.beginPath();
    for (let i = 0; i <= peakIndex; i++) {
