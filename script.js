...
(function () {
  ...
  window.addEventListener("DOMContentLoaded", function () {
    ...
    originalCards.forEach((card) => {
      ...
      // Cloned nodes duplicate id-less interactive elements safely,
      // but strip any ids to keep the document valid.
...
/* ============================================================
   FORCE-DOWNLOAD ENGINE (opt-in only)
   Only links explicitly marked with [data-force-download] trigger
   an automatic blob-based "Save As" download instead of opening
   the file in a new tab. Every other link on the site behaves
   normally. Falls back to a plain new-tab open if the fetch fails
   (e.g. offline, or a future CORS/host change).
   ============================================================ */
(function () {
  'use strict';
